...
final class WorktreeStoreTests: XCTestCase {
    ...
    // TODO(Task 5): needs moveRepo(id:toSection:atIndex:), not yet on the branch. Uncomment
    // once Task 5 lands `moveRepo` on WorktreeStore — this test is otherwise complete and
